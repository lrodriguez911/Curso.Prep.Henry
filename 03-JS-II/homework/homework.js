...
function fizzBuzz(numero) {
  ...
  numero % 3 === 0 ? "fizz" : numero % 5 === 0 ? "buzz" :  numero;
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  //Si no se cumplen ninguna de las condiciones anteriores, retornar false. 
   return num1 == 0 || num2 == 0 || num3 == 0 ? "Error" :
    ...
    num1 > num2 && num1 > num3 ?  "Número 1 es mayor y positivo" :
...
function esPrimo(numero) {
  ...
  for (let i = 2; i < numero; i++) {
    if (numero % i === 0 && numero % 1 === 0) { return false;
    }
  }
  return true;
}
...
function tablaDelSeis(){
  ...
  let array = []
  const tabla = 6;
  for (let multi = 0; multi < 11; multi++) {
    array.push (tabla * multi);
  }
return array;
}
